        ...
        <div className="flex-1 min-w-0 flex flex-col gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-sm font-medium bg-accent text-on-accent px-4 py-2 rounded-full hover:bg-accent-strong transition-colors disabled:opacity-40"
            >
